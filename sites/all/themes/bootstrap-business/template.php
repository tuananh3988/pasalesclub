...
function bootstrap_business_preprocess_html(&$variables) {
	...
	drupal_add_css(path_to_theme() . '/css/global.css', array('group' => CSS_THEME, 'preprocess' => FALSE));
	/**
	* Add Javascript for enable/disable Bootstrap 3 Javascript
	*/
	drupal_add_js(drupal_get_path('theme', 'bootstrap_business') . '/js/directory.js');
